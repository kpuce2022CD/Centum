...
const ProjectDetail = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchProjectRulesData = () => {
            setLoading(true);
            try {
                axios.get('/api/projects/' + id + '/rules').then(response => {
        ...
        const fetchProjectPlansData = () => {
            setLoading(true);
            try {
                axios.get('/api/projects/' + id + '/plans').then(response => {
        ...
        const fetchProjectMemberData = () => {
            setLoading(true);
            try {
                axios.get('/api/projects/' + id + '/projectMembers').then(response => {
        ...
        const fetchProjectSkillData = () => {
            setLoading(true);
            axios.get('/api/projects/'+ id +'/skills').then(response => {
    ...
    const analysisProject = () => {
        ...
        if (window.confirm('프로젝트를 분석하시겠습니까?')) {
            ...
            setLoading(true);
            try {
                axios.post('/api/projects/' + id + '/analysis', github).then(response => {
                    setProjectSkills(response.data.data.projectSkills);
